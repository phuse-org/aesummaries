(function(global, factory) {
  ...
  function makeBody(testData) {
    ...
    */
    .attr('title', function(d) {
      return `p = ${parseFloat(d[config.p_col]).toFixed(2)}
      CI = [${parseFloat(d[config.result_lower_col]).toFixed(2)}, ${parseFloat(d[config.result_upper_col]).toFixed(2)}]`
    })
