...
Application to generate/visualize Adverse Events related tables and figures.

## Purpose

The purpose of this Application is to visualize the AE (Adverse Event) dataset through Interactive R shiny Graphs (Volcano and Forest plot). In this Application, we can generate the plots which will be according to the filters that we select. 
Since we have many table of tables to visualize certain statistics and measures for AE, we can simply use this app to display plots for all the combinations
...
* Build a toolbox of re-usable functions and utilities to create AE-specific tables and figures.
* AE datastes which is used to create tables and figures should follow CDISC standards.
